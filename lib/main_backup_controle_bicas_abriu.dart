...
class LoginScreen extends StatelessWidget {
  ...
  void entrarComo(BuildContext context, String perfil) {
  ...
  Widget construirBotaoPerfil({
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () => entrarComo(context, perfil),
      ),
    );
  }
    ...
    return const Text(
      ...
      style: TextStyle(
        ...
        color: Color(0xFF00843D),
          ...
          const Text(
            'Login simulado para validação dos fluxos do aplicativo.',
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 15,
              color: Color(0xFF4B5563),
          ...
          construirBotaoPerfil(
            context: context,
            perfil: 'Inspetor',
            icone: Icons.assignment_outlined,
            descricao: 'Executa checklists, registra evidências e envia relatórios.',
          ),
          ...
          construirBotaoPerfil(
            ...
            descricao: 'Acompanha relatórios, aprova ou recusa inspeções.',
          ),
          ...
          construirBotaoPerfil(
            ...
            descricao: 'Visualiza resultados, indicadores e histórico geral.',
          ),
          ...
          construirBotaoPerfil(
            ...
            descricao: 'Acessa rotinas operacionais como bicas e limpeza.',
          ),
        ],
      ),
    );
...
void abrirControleBicas(BuildContext context) {
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => const ControleBicasScreen(),
    ),
  );
}
...
void trocarPerfil(BuildContext context) {
  ...
  @override
  Widget build(BuildContext context) {
    final bool podeIniciarChecklist = perfil == 'Inspetor';
    final bool podeVerResultados =
      perfil == 'Inspetor' || perfil == 'Supervisor' || perfil == 'Gerência';
    final bool podeVerPainelSupervisor = perfil == 'Supervisor';
    final bool perfilOperador = perfil == 'Operador';
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          OutlinedButton.icon(
            onPressed: () => abrirControleBicas(context),
            icon: const Icon(Icons.grid_view_outlined),
            label: const Text('Controle de Bicas'),
            style: OutlinedButton.styleFrom(
              foregroundColor: const Color(0xFF00843D),
              side: const BorderSide(
                color: Color(0xFF00843D),
          ...
          const Text(
            'Registro de Limpeza — em desenvolvimento',
            style: TextStyle(
              color: Color(0xFF4B5563),
              fontSize: 15,
            ),
...
class ControleBicasScreen extends StatelessWidget {
            ...
            child: const Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Controle operacional das bicas do armazém de farelo.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: Color(0xFF4B5563),
                      fontSize: 15,
            ...
            child: const Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Na próxima versão desta tela, serão exibidas as 31 bicas em quadradinhos, divididas em 4 setores, com status visual por cor.',
                    style: TextStyle(
                      color: Color(0xFF4B5563),
                      fontSize: 15,
                      height: 1.4,
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Ações planejadas: registrar entrada de farelo, registrar retirada/recolhimento e consultar histórico por bica.',
                    style: TextStyle(
                      color: Color(0xFF4B5563),
                      fontSize: 15,
                      height: 1.4,
